...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pick_external_db_file,
            commands::connect_external_db,
            commands::disconnect_external_db,
            commands::list_external_connections,
            commands::get_db_path,
            commands::list_folders,
            commands::create_folder,
            commands::rename_folder,
            commands::delete_folder,
            commands::move_table_to_folder,
            commands::reorder_folders,
            commands::get_record_detail,
            commands::list_record_notes,
            commands::create_record_note,
            commands::delete_record_note,
        ])
